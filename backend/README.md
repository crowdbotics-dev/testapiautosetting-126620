...
## Project Structure
    ...
    ├── testapiautosetting_126620  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126620`
...
2. Clone this repo and `cd testapiautosetting_126620`
